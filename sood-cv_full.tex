...
\begin{itemize}
  % \item 2026: Asian School in Economic Theory (\textsc{hong kong university}), Africa Meeting of Econometric Society (\textsc{u. cairo}) 
...
\begin{itemize}
  \item 2025: Asian School in Economic Theory (\textsc{nyu abu dhabi})
  \item 2023: DSE Deep Learning (\textsc{u. lausanne})
  \item 2022: DSE Empirical Market Design (\textsc{mit})
\end{itemize}

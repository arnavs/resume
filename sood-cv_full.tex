...
\begin{itemize}
  \item Behavioral, Learning, Information, Game Theory, Computation
\end{itemize} 
...
\subsubsection*{Conference Presentations and Seminars (Workshops$^{\dagger}$)}
\begin{itemize}
  \item 2024: SAET (\textsc{U. Chile}), Theory Brown Bag (\textsc{U. Pitt.})
...
\begin{itemize}
  ...
  \item Volunteer, US National Science Bowl
\end{itemize}
\end{document}

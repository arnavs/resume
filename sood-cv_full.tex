...
\begin{itemize}
  ...
  \item Dual-Enrolled Student, Princeton University \hfill 2013
\end{itemize} 
...
\begin{tabularx}{\textwidth}{X Z Y} 
  TA (CMU) & Strategic Corp. Mgmt. (MBA) & 2023 \\ 
  TA (CMU) & Metrics III (PhD) & 2023 \\ 
  TA (CMU) & Macro II (PhD) & 2023 \\ 
  TA (CMU) & Macro I (PhD) & 2022 \\ 
  Guest Lecturer (UBC) & Economics Courses & 2019
\end{tabularx}
